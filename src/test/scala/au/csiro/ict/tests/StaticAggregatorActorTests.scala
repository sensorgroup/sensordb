...
class StaticAggregatorActorTests(_system: ActorSystem) extends TestKit(_system) with  ScalatraSuite with ImplicitSender with FunSuite with BeforeAndAfterAll   {
  ...
  test("Static Aggregated Statistics Calculation Actor; First inserted received"){
    ...
    val lvl4=Insert(OneHourLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,FifteenMinuteLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
    val lvl5=Insert(ThreeHourLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneHourLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
    val lvl6=Insert(SixHourLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,ThreeHourLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
    val lvl7=Insert(OneDayLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,SixHourLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
    val lvl8=Insert(OneMonthLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneDayLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
    val lvl9=Insert(OneYearLevel.id,sid,ts2012_1_1_0_0_0_0,5,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneMonthLevel.id,List[Double](ts1Int,ts1Int,5,5,1.0,5,5*5))))
  ...
  test("Static Aggregated Statistics Calculation Actor; A Second insert received"){
    ...
    val lvl4=Insert(OneHourLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,FifteenMinuteLevel.id,List[Double](ts1Int,ts1Int,1,1,1.0,1,1*1))))
    val lvl5=Insert(ThreeHourLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,OneHourLevel.id,List[Double](ts1Int,ts1Int,1,1,1.0,1,1*1))))
    val lvl6=Insert(SixHourLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,ThreeHourLevel.id,List[Double](ts1Int,ts1Int,1,1,1.0,1,1*1))))
    val lvl7=Insert(OneDayLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,SixHourLevel.id,List[Double](ts1Int,ts1Int,1,1,1.0,1,1*1))))
    val lvl8=Insert(OneMonthLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,OneDayLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts1Int,1,5,2.0,6,5*5+1*1))))
    val lvl9=Insert(OneYearLevel.id,sid,ts2012_1_1_18_0_0_0,1,Some(StatResult(sid,ts2012_1_1_18_0_0_0,OneMonthLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts1Int,1,5,2.0,6,5*5+1*1))))
  ...
  test("Static Aggregated Statistics Calculation Actor; An update over first item received"){
    ...
    val lvl4=Update(OneHourLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,FifteenMinuteLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_0_0_0_0_int,-2,-2,1.0,-2,4))))
    val lvl5=Update(ThreeHourLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneHourLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_0_0_0_0_int,-2,-2,1.0,-2,4))))
    val lvl6=Update(SixHourLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,ThreeHourLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_0_0_0_0_int,-2,-2,1.0,-2,4))))
    val lvl7=Update(OneDayLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,SixHourLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_0_0_0_0_int,-2,-2,1.0,-2,4))))
    val lvl8=Update(OneMonthLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneDayLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_18_0_0_0_int,-2,1,2.0,-1,4+1))))
    val lvl9=Update(OneYearLevel.id,sid,ts2012_1_1_0_0_0_0,Some(StatResult(sid,ts2012_1_1_0_0_0_0,OneMonthLevel.id,List[Double](ts2012_1_1_0_0_0_0_int,ts2012_1_1_18_0_0_0_int,-2,1,2.0,-1,4+1))))
    val lvl10=Done(sid,ts2012_1_1_0_0_0_0)
    staticAggregator ! lvl0
    expectMsg(lvl1)
    staticAggregator ! lvl1
